...
export default function AdminLayout({ children, darkMode, toggleDarkMode }) {
  ...
  const routes = [
    ...
    },
    {
      ...
      active: location.pathname.includes("/dashboard/delegation"),
      submenu: true,
      showFor: ["admin", "user"] // Show for both roles
    },
     
     {
      ...
      label: "Structure",
      icon: LayoutPanelTop,
      active: location.pathname.includes("/dashboard/quick-task"),
      submenu: true,
      showFor: ["admin", "user"] // Show for both roles
    },
    {
    ...
    <div className={`flex h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50`}>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="flex h-14 items-center justify-between border-b border-blue-200 bg-white px-4 md:px-6">
          ...
          <h1 className="text-lg font-semibold text-blue-700">SRM Projects</h1>
